...
namespace GIGA.PixelCableRenderer.Demo
{
    public class CableRendererDemoManager : MonoBehaviour
    {
        ...
        private void OnGUI()
		{
			...
			if (cableRenderer.colorMode == CableRenderer.ColorMode.FullTexture || cableRenderer.colorMode == CableRenderer.ColorMode.RepeatedTexture || cableRenderer.colorMode == CableRenderer.ColorMode.PixelTexture)
			{
				GUILayout.Label("Textures are not available in the LITE package.");
                extraSpace += 30;
			}
        ...
        private void UpdateInfoText()
        {
            ...
            else
            {
                ...
                // param info
                GUI.Label(new Rect(10, Screen.height - 340 + extraSpace, 400, 40), this.NormalizeFieldName(this.fields[this.selectedFieldIndex].Name), this.titleLabel);
                GUI.Label(new Rect(10, Screen.height - 300 + extraSpace, 400, 100), sbInfo.ToString(), this.infoLabel);

                // tips
                if (sbTips.Length > 0)
                {
                    GUI.Label(new Rect(10, Screen.height - 240 + extraSpace, 400, 40), "TIPS:", this.titleLabel);
                    GUI.Label(new Rect(10, Screen.height - 200 + extraSpace, 400, 100), sbTips.ToString(), this.infoLabel);
                }
